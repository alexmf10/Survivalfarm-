...
# key → res:// path; add .ogg files to match these paths and reimport in Godot
const SOUNDS: Dictionary = {
	...
	"player_hurt":    "res://assets/audio/sfx/combat/player_hurt.ogg",
	# UI
	"ui_open":        "res://assets/audio/sfx/ui/open.ogg",
	"ui_close":       "res://assets/audio/sfx/ui/close.ogg",
	"buy":            "res://assets/audio/sfx/ui/buy.ogg",
	# Story
